          ...
          <div className="grid sm:grid-cols-2 gap-8 md:gap-x-12 md:gap-y-16">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed">
                번역 키와 언어를 행과 열로 구성된 테이블에서 직접 편집할 수 있습니다. 
                복잡한 인터페이스 없이, 필요한 것만 담았습니다.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed">
                프로젝트별 API Key를 발급받아 GET 요청 하나로 모든 번역 데이터를 가져올 수 있습니다.
                별도의 SDK나 설정이 필요 없습니다.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed">
                번역을 수정하면 즉시 API에 반영됩니다. 
                앱스토어 심사나 재배포를 기다릴 필요가 없습니다.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed">
                프로젝트, 언어, 번역 키 개수에 제한이 없습니다. 
                팀 규모나 프로젝트 크기에 상관없이 자유롭게 사용하세요.
              </p>
            </div>
          </div>
        </div>
...
const response = await fetch(
  'https://api.verbasync.com/v1/{apiKey}/ko.json'
);
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">
              © 2024 Verbasync. All rights reserved.
            </div>
            <div className="flex gap-4 sm:gap-6 text-xs sm:text-sm">
              <a href="#" className="text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors">
                문서
              </a>
              <a href="#" className="text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors">
                API
